...
class CountdownApp:
    ...
    def blink(self):
        ...
        root.attributes('-alpha', 0.0)  # Set initial transparency to 0%
        root.configure(bg='black')

        label = tk.Label(root, text="Blink your eyes", font=("Helvetica", 48), fg="white", bg="black")
        ...
        def fade_in():
            ...
            if current_alpha < 1.0:
                ...
                root.after(50, fade_in)  # Schedule the next step in 50 milliseconds
